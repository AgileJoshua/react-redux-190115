...
class App extends Component<{}, State> {
  ...
  render() {
    return (
      <>
        <Menu title={'This is the main menu'} isLoading={this.state.isLoading} filter={this.state.filterName} items={this.menuItems} shoppingCart={this.state.cart} onClick={this.onFilter}></Menu>
        <div className="App">
