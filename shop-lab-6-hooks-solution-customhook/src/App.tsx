...
import { withCartContext } from './context/shoppingcart/CartContextProvider';
...
class App extends Component<{}, State> {
  ...
  render() {
    return (
      <><button onClick={()=>{this.setState({showMenu:!this.state.showMenu})}}>Remove Menu</button>
        {this.state.showMenu && <Menu  title={'This is the main menu'} isLoading={this.state.isLoading} filter={this.state.filterName} items={this.menuItems} onClick={this.onFilter}></Menu>}
        <div className="App">
          <h1>All the products</h1>
          <ProductList products={this.state.listedProducts}></ProductList>
        </div>
...
export default withCartContext(App);
